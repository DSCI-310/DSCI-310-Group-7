...
LR = train_and_predict_model.final_Model("LR", -1, X_train, X_test, y_train, y_test, X, y)
...
svec = train_and_predict_model.final_Model("SVM", -1, X_train, X_test, y_train, y_test, X, y)
